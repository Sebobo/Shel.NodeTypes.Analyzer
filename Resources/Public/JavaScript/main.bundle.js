...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ../Styles/styles.scss */ "./Resources/Private/Styles/styles.scss");
window.onload = function () {
    const nodeTypesGraphContainer = document.querySelector('.nodetypes-graph');
    const nodeTypesForm = nodeTypesGraphContainer.querySelector('form');
    const nodeTypesFormBaseNodeTypeField = nodeTypesForm.querySelector('select[name="moduleArguments[baseNodeType]"');
    const nodeTypesGraph = nodeTypesGraphContainer.querySelector('object');
    const nodeTypeGroups = JSON.parse(nodeTypesGraphContainer.dataset.nodetypeGroups);
    ...
    Object.keys(nodeTypeGroups).forEach(nodeTypeGroup => {
        graphSvgSource = graphSvgSource.replace(nodeTypeGroup, nodeTypeGroups[nodeTypeGroup].name);
    });
...
/***/ "./Resources/Private/Styles/styles.scss":
/*!**********************************************!*\
  !*** ./Resources/Private/Styles/styles.scss ***!
  \**********************************************/
/*! no static exports found */
